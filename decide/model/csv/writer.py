...
def write_exchanges(filename: str, realized: List[EqualGainExchange], delimiter=";", lineterminator="\n"):
    """
    ...
    with open(filename, "w") as csv_file:
        writer = csv.writer(csv_file, delimiter=delimiter, lineterminator=lineterminator)

...
def get_all_actors_by_model_run_ids_sql(model_run_ids) -> str:
...
def list_to_sql_param(list_object) -> str:
    ...
    :return:
    """
    return ",".join([f"'{x}'" for x in list_object])
